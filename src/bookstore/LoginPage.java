...
public class LoginPage extends javax.swing.JFrame {
    ...
    public LoginPage() {
        initComponents();
        echoChar=passField.getEchoChar();
    }
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(462, 400));
        setPreferredSize(new java.awt.Dimension(1101, 531));

        jPanel1.setBackground(new java.awt.Color(255, 255, 255));
        jPanel1.setForeground(new java.awt.Color(51, 51, 51));
        jPanel1.setMaximumSize(new java.awt.Dimension(865, 500));
        jPanel1.setMinimumSize(new java.awt.Dimension(462, 400));

        jPanel2.setBackground(new java.awt.Color(0, 153, 153));
        jPanel2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jPanel2.setMaximumSize(new java.awt.Dimension(925, 925));
        ...
        jPanel3.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED, new java.awt.Color(204, 204, 204), new java.awt.Color(0, 102, 102), new java.awt.Color(51, 51, 51), new java.awt.Color(204, 255, 204)));

        loginButton.setBackground(new java.awt.Color(0, 102, 102));
        loginButton.setFont(new java.awt.Font("Rockwell Extra Bold", 0, 12)); // NOI18N
        ...
        userField.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 5, 1));
        ...
        forgotPassButton.setBackground(new java.awt.Color(153, 153, 153));
        forgotPassButton.setFont(new java.awt.Font("Berlin Sans FB", 0, 11)); // NOI18N
        forgotPassButton.setForeground(new java.awt.Color(238, 255, 253));
        forgotPassButton.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        ...
        passField.setAlignmentY(1.0F);
        passField.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 5, 1));
        passField.setPreferredSize(new java.awt.Dimension(155, 20));
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/bookstore/eye.jpg"))); // NOI18N
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(forgotPassButton, javax.swing.GroupLayout.PREFERRED_SIZE, 18, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(20, 20, 20)
                .addComponent(loginButton)
                .addContainerGap())
        );

        jLabel5.setFont(new java.awt.Font("Bahnschrift", 2, 11)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(153, 153, 153));
        jLabel5.setText("Welcome, sign in to continue");
    ...
    private void loginButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginButtonActionPerformed
        ...
        try{
            if(name.equals("")||pass.equals("")){
                JOptionPane.showMessageDialog(null,"Fill in details to proceed");
                err=false;
            }
            else
            {
                String acct = confirmUser(name,pass);
                if (!acct.equals(null)) {
                    Book_Store.user=acct;
...
//            dispose();
    ...
    private void userFieldKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_userFieldKeyTyped
       ...
       if( evt.getKeyChar()=='\n' && userField.getText().length() >=5 ){
           userField.transferFocus();
       }   
//       Image img = null;
//        try {
//            img = ImageIO.read(new File("bookLogo1.png"));
//        } catch (IOException ex) {
//            Logger.getLogger(LoginPage.class.getName()).log(Level.SEVERE, null, ex);
//        }
//       jPanel2.getGraphics().drawImage(img,0, 0, this);
...
//        if (userField.getText().equals("username")&&userField.getForeground().equals(Color.lightGray)) {
...
//            userField.getFont().deriveFont(3);
//            userField.setText("username");
////        userField.getGraphics().setColor(Color.gray);
////            userField.getGraphics().drawString("username", WIDTH, HEIGHT);
//        }
        userFieldSetBorder();
    ...
    private void forgotPassButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_forgotPassButtonMouseClicked
        forgotPassButton.setForeground(Color.red);
        forgotPassPage test = new forgotPassPage();
        test.setLocation(this.getLocation().x>3?this.getLocation():new Point(70, 70));
    ...
    private void forgotPassButtonMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_forgotPassButtonMouseEntered
        forgotPassButton.setForeground(new Color(128,255,253));
    ...
    private void forgotPassButtonMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_forgotPassButtonMouseExited
        forgotPassButton.setForeground(new Color(238,255,253));
    ...
    private void passFieldBorderSet() {
        if (passField.getText().length()<5) {
            passField.setBorder(new LineBorder(Color.RED));
            passField.setToolTipText("password must be upto 6 char");
    ...
    public void userFieldSetBorder(){
         if (userField.getText().length()<5) {
            userField.setBorder(new LineBorder(Color.RED));
            userField.setToolTipText("username must be upto 5");
            
        }else{
            userField.setBorder(new BevelBorder(BevelBorder.RAISED));
            userField.setToolTipText("Username");
        }
    }
    
    //to check login details
     public String confirmUser(String user,String pass) {
        ...
        try {
            ...
            while (allUser.next()) {
                if(user.equals(allUser.getString("username"))&&pass.equals(allUser.getString("password")))
                    return allUser.getString("acctType");
